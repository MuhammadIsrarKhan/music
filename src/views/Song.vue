...
<script>
import { auth, commentsCollection, db } from '@/includes/firebase'
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: 'Please wait! Your commentis being submitted'
    }
  },
  computed: {
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Please wait! Your commentis being submitted'
